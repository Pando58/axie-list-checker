  ...
  <div class="container max-w-3xl p-4 mx-auto">
    ...
    <div class="flex items-center mb-4">
      <label for="toggle" class="flex items-center cursor-pointer">
        <div class="relative">
          <input v-model="toggle" @change="toggleTimer" id="toggle" type="checkbox" class="sr-only"/>
    ...
    <div class="mb-4">
      ...
      <div class="relative w-20">
        <select v-model="timerSelect" @change="resetTimer" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 text-sm py-2 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="timer-select">
    ...
    <div class="mb-4">
      ...
      <div class="relative w-28">
        <select v-model="sort" @change="resetTimer" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 text-sm py-2 px-2 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="sort-select">
